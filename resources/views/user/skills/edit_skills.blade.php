                ...
                <div class="skill-edit-card {{ $hasSkill ? 'is-active' : '' }}">
                    <div class="card-main">
                        ...
                        <div class="skill-info">
                            ...
                            <p class="skill-hint">{{ Str::limit($skill->description, 120) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="level-box {{ $hasSkill ? '' : 'disabled' }}">
                        <div class="select-container">
                            ...
                            <select name="nivel_academico[{{ $skill->id }}]" class="level-select">
                                ...
                                <option value="avancado" @if($currentLevel == 'avancado') selected @endif>Nível Avançado</option>
                            </select>
                        </div>
                    </div>
                </div>
...
/* Checkbox maior e visível */
.checkbox-wrapper {
    position: relative;
    width: 32px; height: 32px;
    flex-shrink: 0;
}
.skill-toggle { position: absolute; opacity: 0; width: 100%; height: 100%; cursor: pointer; z-index: 2; }
.toggle-label {
